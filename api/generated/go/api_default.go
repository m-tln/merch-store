...
func (c *DefaultAPIController) ApiSendCoinPost(w http.ResponseWriter, r *http.Request) {
	...
	if err := AssertSendCoinRequestRequired(bodyParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertSendCoinRequestConstraints(bodyParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
...
func (c *DefaultAPIController) ApiAuthPost(w http.ResponseWriter, r *http.Request) {
	...
	if err := AssertAuthRequestRequired(bodyParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertAuthRequestConstraints(bodyParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
